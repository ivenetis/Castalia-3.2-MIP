...
#  opp_makemake -f -r --deep -o CastaliaBin -u Cmdenv -P /root/Work/Projects/PROSENS/Castalia-3.2-MIP -M release -X Simulations -X out -X bin
#
...
INCLUDE_PATH = \
    ...
    -Isrc/node/application/BST_MIP_MH \
    -Isrc/node/application/connectivityMap \
    -Isrc/node/application/EMIP_MIP_MH \
    -Isrc/node/application/ILS_MIP_MH \
    -Isrc/node/application/NOID_MIP_MH \
    -Isrc/node/application/simpleAggregation \
    -Isrc/node/application/TBID_MIP_MH \
    -Isrc/node/application/throughputTest \
    -Isrc/node/application/valuePropagation \
    -Isrc/node/application/valueReporting \
    -Isrc/node/application/VCL_MIP_MH \
...
OBJS = \
    ...
    $O/src/node/application/BST_MIP_MH/BST_MIP_MH.o \
    $O/src/node/application/connectivityMap/ConnectivityMap.o \
    $O/src/node/application/EMIP_MIP_MH/EMIP_MIP_MH.o \
    $O/src/node/application/ILS_MIP_MH/ILS_MIP_MH.o \
    $O/src/node/application/NOID_MIP_MH/NOID_MIP_MH.o \
    $O/src/node/application/simpleAggregation/SimpleAggregation.o \
    $O/src/node/application/TBID_MIP_MH/TBID_MIP_MH.o \
    ...
    $O/src/node/application/VCL_MIP_MH/VCL_MIP_MH.o \
    ...
    $O/src/node/application/BST_MIP_MH/BST_MIP_MH_MA_Pkt_m.o \
    $O/src/node/application/BST_MIP_MH/BST_MIP_MH_PosPkt_m.o \
    $O/src/node/application/EMIP_MIP_MH/EMIP_MIP_MH_MA_Pkt_m.o \
    $O/src/node/application/EMIP_MIP_MH/EMIP_MIP_MH_PosPkt_m.o \
    $O/src/node/application/ILS_MIP_MH/ILS_MIP_MH_MA_Pkt_m.o \
    $O/src/node/application/ILS_MIP_MH/ILS_MIP_MH_PosPkt_m.o \
    $O/src/node/application/NOID_MIP_MH/NOID_MIP_MH_MA_Pkt_m.o \
    $O/src/node/application/NOID_MIP_MH/NOID_MIP_MH_PosPkt_m.o \
    $O/src/node/application/TBID_MIP_MH/TBID_MIP_MH_MA_Pkt_m.o \
    $O/src/node/application/TBID_MIP_MH/TBID_MIP_MH_PosPkt_m.o \
    $O/src/node/application/valueReporting/ValueReportingPacket_m.o \
    $O/src/node/application/VCL_MIP_MH/VCL_MIP_MH_MA_Pkt_m.o \
    $O/src/node/application/VCL_MIP_MH/VCL_MIP_MH_PosPkt_m.o \
...
MSGFILES = \
    ...
    src/node/application/BST_MIP_MH/BST_MIP_MH_MA_Pkt.msg \
    src/node/application/BST_MIP_MH/BST_MIP_MH_PosPkt.msg \
    src/node/application/EMIP_MIP_MH/EMIP_MIP_MH_MA_Pkt.msg \
    src/node/application/EMIP_MIP_MH/EMIP_MIP_MH_PosPkt.msg \
    src/node/application/ILS_MIP_MH/ILS_MIP_MH_MA_Pkt.msg \
    src/node/application/ILS_MIP_MH/ILS_MIP_MH_PosPkt.msg \
    src/node/application/NOID_MIP_MH/NOID_MIP_MH_MA_Pkt.msg \
    src/node/application/NOID_MIP_MH/NOID_MIP_MH_PosPkt.msg \
    src/node/application/TBID_MIP_MH/TBID_MIP_MH_MA_Pkt.msg \
    src/node/application/TBID_MIP_MH/TBID_MIP_MH_PosPkt.msg \
    src/node/application/valueReporting/ValueReportingPacket.msg \
    src/node/application/VCL_MIP_MH/VCL_MIP_MH_MA_Pkt.msg \
    src/node/application/VCL_MIP_MH/VCL_MIP_MH_PosPkt.msg \
...
clean:
	...
	-rm -f src/node/application/BST_MIP_MH/*_m.cc src/node/application/BST_MIP_MH/*_m.h
	-rm -f src/node/application/connectivityMap/*_m.cc src/node/application/connectivityMap/*_m.h
	-rm -f src/node/application/EMIP_MIP_MH/*_m.cc src/node/application/EMIP_MIP_MH/*_m.h
	-rm -f src/node/application/ILS_MIP_MH/*_m.cc src/node/application/ILS_MIP_MH/*_m.h
	-rm -f src/node/application/NOID_MIP_MH/*_m.cc src/node/application/NOID_MIP_MH/*_m.h
	-rm -f src/node/application/simpleAggregation/*_m.cc src/node/application/simpleAggregation/*_m.h
	-rm -f src/node/application/TBID_MIP_MH/*_m.cc src/node/application/TBID_MIP_MH/*_m.h
	...
	-rm -f src/node/application/valueReporting/*_m.cc src/node/application/valueReporting/*_m.h
	-rm -f src/node/application/VCL_MIP_MH/*_m.cc src/node/application/VCL_MIP_MH/*_m.h
...
$O/src/node/application/bridgeTest/BridgeTest.o: src/node/application/bridgeTest/BridgeTest.cc \
  ...
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/node/mobilityManager/VirtualMobilityManager.h
$O/src/node/application/BST_MIP_MH/BST_MIP_MH.o: src/node/application/BST_MIP_MH/BST_MIP_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/BST_MIP_MH/BST_MIP_MH_PosPkt_m.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/application/BST_MIP_MH/BST_MIP_MH.h \
  src/node/communication/mac/MacPacket_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/application/BST_MIP_MH/BST_MIP_MH_MA_Pkt_m.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
...
$O/src/node/application/connectivityMap/ConnectivityMap.o: src/node/application/connectivityMap/ConnectivityMap.cc \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/EMIP_MIP_MH/EMIP_MIP_MH.o: src/node/application/EMIP_MIP_MH/EMIP_MIP_MH.cc \
  src/node/application/EMIP_MIP_MH/EMIP_MIP_MH_PosPkt_m.h \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  ...
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/application/EMIP_MIP_MH/EMIP_MIP_MH_MA_Pkt_m.h \
  src/node/communication/mac/MacPacket_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/application/EMIP_MIP_MH/EMIP_MIP_MH.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/ILS_MIP_MH/ILS_MIP_MH.o: src/node/application/ILS_MIP_MH/ILS_MIP_MH.cc \
  src/node/application/ILS_MIP_MH/tree.hh \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/node/application/ILS_MIP_MH/tree_util.hh \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/application/ILS_MIP_MH/ILS_MIP_MH_PosPkt_m.h \
  src/node/application/ILS_MIP_MH/ILS_MIP_MH_MA_Pkt_m.h \
  src/node/application/ILS_MIP_MH/ILS_MIP_MH.h \
  src/node/communication/mac/MacPacket_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/ILS_MIP_MH/ILS_MIP_MH_MA_Pkt_m.o: src/node/application/ILS_MIP_MH/ILS_MIP_MH_MA_Pkt_m.cc \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/ILS_MIP_MH/ILS_MIP_MH_MA_Pkt_m.h
$O/src/node/application/ILS_MIP_MH/ILS_MIP_MH_PosPkt_m.o: src/node/application/ILS_MIP_MH/ILS_MIP_MH_PosPkt_m.cc \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/ILS_MIP_MH/ILS_MIP_MH_PosPkt_m.h
$O/src/node/application/NOID_MIP_MH/NOID_MIP_MH.o: src/node/application/NOID_MIP_MH/NOID_MIP_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/node/application/NOID_MIP_MH/NOID_MIP_MH_PosPkt_m.h \
  src/node/application/NOID_MIP_MH/tree_util.hh \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/communication/mac/MacPacket_m.h \
  src/node/application/NOID_MIP_MH/NOID_MIP_MH_MA_Pkt_m.h \
  src/node/application/NOID_MIP_MH/tree.hh \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/application/NOID_MIP_MH/NOID_MIP_MH.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
...
$O/src/node/application/simpleAggregation/SimpleAggregation.o: src/node/application/simpleAggregation/SimpleAggregation.cc \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/TBID_MIP_MH/TBID_MIP_MH.o: src/node/application/TBID_MIP_MH/TBID_MIP_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/node/application/TBID_MIP_MH/TBID_MIP_MH.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/application/TBID_MIP_MH/TBID_MIP_MH_PosPkt_m.h \
  src/node/application/TBID_MIP_MH/tree.hh \
  src/node/communication/mac/MacPacket_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/application/TBID_MIP_MH/tree_util.hh \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/application/TBID_MIP_MH/TBID_MIP_MH_MA_Pkt_m.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
...
$O/src/node/application/valueReporting/ValueReporting.o: src/node/application/valueReporting/ValueReporting.cc \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/VCL_MIP_MH/VCL_MIP_MH.o: src/node/application/VCL_MIP_MH/VCL_MIP_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  ...
  src/node/communication/radio/Radio.h \
  src/node/communication/mac/MacPacket_m.h \
  src/node/application/VCL_MIP_MH/VCL_MIP_MH_PosPkt_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/application/VCL_MIP_MH/VCL_MIP_MH_MA_Pkt_m.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/node/application/VCL_MIP_MH/VCL_MIP_MH.h

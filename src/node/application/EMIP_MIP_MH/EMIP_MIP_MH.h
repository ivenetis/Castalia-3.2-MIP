#ifndef _EMIP_MIP_MH_H_
#define _EMIP_MIP_MH_H_

#include <climits>
#include "VirtualApplication.h"
#include "EMIP_MIP_MH_PosPkt_m.h"
#include "EMIP_MIP_MH_MA_Pkt_m.h"
...
#define REQUEST_POSITIONS_PACKET	"EMIP_MIP_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"EMIP_MIP_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"EMIP_MIP_MH END_OF_TURN_PACKET"
#define MA_PACKET			"EMIP_MIP_MH MA_PACKET"
...
namespace EMIP_MIP_MH_NS {
	...
	class EMIP_MIP_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	a;
		double	sigma;
...
using namespace EMIP_MIP_MH_NS;

#endif	// _EMIP_MIP_MH_H_

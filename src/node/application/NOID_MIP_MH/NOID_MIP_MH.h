#ifndef _NOID_MIP_MH_H_
#define _NOID_MIP_MH_H_

#include <climits>
#include "VirtualApplication.h"
#include "NOID_MIP_MH_PosPkt_m.h"
#include "NOID_MIP_MH_MA_Pkt_m.h"
#include "tree.hh"
...
#define REQUEST_POSITIONS_PACKET	"NOID_MIP_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"NOID_MIP_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"NOID_MIP_MH END_OF_TURN_PACKET"
#define MA_PACKET			"NOID_MIP_MH MA_PACKET"
...
namespace NOID_MIP_MH_NS {
	...
	class NOID_MIP_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	a;
		double	f;
	...
	vector< set<int> >	I;
	vector< double >	C;
	vector< tree<int> >	branch;
	vector< tree<int> >	workingBranch;
	list<double>		time;
	vector<int>		PrevVect;
...
using namespace NOID_MIP_MH_NS;

#endif	// _NOID_MIP_MH_H_

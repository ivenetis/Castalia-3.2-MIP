#ifndef _TBID_MIP_MH_H_
#define _TBID_MIP_MH_H_

#include <climits>
#include "VirtualApplication.h"
#include "TBID_MIP_MH_PosPkt_m.h"
#include "TBID_MIP_MH_MA_Pkt_m.h"
#include "tree.hh"
...
#define REQUEST_POSITIONS_PACKET	"TBID_MIP_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"TBID_MIP_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"TBID_MIP_MH END_OF_TURN_PACKET"
#define MA_PACKET			"TBID_MIP_MH MA_PACKET"
...
namespace TBID_MIP_MH_NS {
	...
	class TBID_MIP_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	a;
		double	f;
...
using namespace TBID_MIP_MH_NS;

#endif	// _TBID_MIP_MH_H_

#ifndef _BST_MIP_MH_H_
#define _BST_MIP_MH_H_

#include <climits>
#include "VirtualApplication.h"
#include "BST_MIP_MH_PosPkt_m.h"
#include "BST_MIP_MH_MA_Pkt_m.h"
...
#define REQUEST_POSITIONS_PACKET	"BST_MIP_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"BST_MIP_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"BST_MIP_MH END_OF_TURN_PACKET"
#define MA_PACKET			"BST_MIP_MH MA_PACKET"
...
namespace BST_MIP_MH_NS {
	...
	class BST_MIP_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	a;
		double	startTime;
		...
		void Prim ( int source, vector<int> &PrevVect );
...
using namespace BST_MIP_MH_NS;

#endif	// _BST_MIP_MH_H_

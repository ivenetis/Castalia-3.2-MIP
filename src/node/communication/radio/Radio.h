...
#if !defined(IVENETIS)
	int getTxLevelListSize();
	list<TxLevel_type>::iterator getTxLevelListBegin();
	list<TxLevel_type>::iterator getTxLevelListEnd();
	list<RXmode_type>::iterator  getRXmodeListBegin();
	list<RXmode_type>::iterator  getRXmodeListEnd();
#endif
};

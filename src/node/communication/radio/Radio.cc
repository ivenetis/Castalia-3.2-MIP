...
#if !defined(IVENETIS)
int Radio::getTxLevelListSize()
{
	return TxLevelList.size();
}

list<TxLevel_type>::iterator Radio::getTxLevelListBegin()
{
	return TxLevelList.begin();
}

list<TxLevel_type>::iterator Radio::getTxLevelListEnd()
{
	return TxLevelList.end();
}

list<RXmode_type>::iterator Radio::getRXmodeListBegin()
{
	return RXmodeList.begin();
}

list<RXmode_type>::iterator Radio::getRXmodeListEnd()
{
	return RXmodeList.end();
}
#endif
